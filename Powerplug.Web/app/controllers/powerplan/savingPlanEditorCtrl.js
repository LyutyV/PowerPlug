...
(function () {
    ...
    angular
        ...
        .controller('SavingPlanEditorCtrl',
                     ['$state', '$stateParams', '$scope', '$document', 'SavingPlansResource', SavingPlanEditorCtrl]);


    function SavingPlanEditorCtrl($state, $stateParams, $scope, $document, SavingPlansResource) {
        var vm = this;
